  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        title: "MongoDB Schema & Query Patterns",
        summary: "Real named schema-design patterns beyond basic embed-vs-reference (the Bucket Pattern and the Subset Pattern), plus aggregation-pipeline basics ($match/$group/$project) and Mongoose schema validation.",
        hasPage: false,
        status: "not-started",
      },
      {
      ...
      {
        slug: "postgresql-advanced-querying",
        title: "PostgreSQL Advanced Querying & Production Patterns",
        summary: "Window functions & CTEs (RANK/ROW_NUMBER/PARTITION BY/WITH), JSONB as a hybrid relational/document column (GIN-indexed, ->/->>/@> operators), and real connection pooling (pg.Pool vs one-connection-per-query, measured under concurrent load).",
        hasPage: false,
        status: "not-started",
      },
      {
        slug: "mongodb-advanced-patterns",
        title: "MongoDB Advanced Patterns & Production Concerns",
        summary: "Advanced aggregation ($lookup/$unwind/$facet), indexes beyond basics (compound, TTL auto-expiry, text), Mongoose middleware/virtuals, and real-time reactivity via Change Streams on the real Atlas replica set.",
        hasPage: false,
        status: "not-started",
      },
    ],
