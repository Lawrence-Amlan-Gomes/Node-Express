    ...
    topics: [
      {
        slug: "sql-vs-nosql",
        title: "SQL vs NoSQL",
        summary: "Choosing a database model for a given problem.",
        hasPage: false,
        status: "not-started",
      },
      {
        ...
        summary: "An ORM/query builder (Prisma/Knex/Mongoose — TBD) wired to a real local database.",
        hasPage: false,
        status: "not-started",
      },
      {
        ...
        summary: "Versioned schema changes and modeling real relationships.",
        hasPage: false,
        status: "not-started",
      },
      {
        ...
        summary: "Transactions, N+1 queries, and other real performance gotchas.",
        hasPage: false,
        status: "not-started",
      },
    ],
