  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        summary: "Wiring up a real local PostgreSQL database via Prisma AND a real local MongoDB database via Mongoose — the same CRUD operations, built and compared side by side, both taught in real depth.",
        hasPage: false,
        status: "not-started",
      },
      {
