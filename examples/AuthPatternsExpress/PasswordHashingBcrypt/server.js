...
// endpoint — that lives in controllers/, one layer down. A real backend
// never calls bcrypt from a bare script — it always lives behind a real
// register/login API, same as here.
...
// Needed so POST /users/register and POST /users/login can read req.body.
