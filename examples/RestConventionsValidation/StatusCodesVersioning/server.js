...
// Needed so POST /api/v1/todos can read req.body.
app.use(express.json());

// URL-path versioning: the version lives right in the mount path
// ("/api/v1/todos"), not in a header or query param. This is the 2026
...
// inspection needed to know "this is a v1 response." server.js doesn't
// need to know or care what's inside todosRouter — it just hands off
// anything starting with "/api/v1/todos" to it.
