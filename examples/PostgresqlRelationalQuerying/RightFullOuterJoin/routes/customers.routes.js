// This is the customers.routes.js file for the "RightFullOuterJoin"
...
const { createCustomer, listCustomers, deleteAllCustomers } = require("../controllers/customers.controller"); // Get these 3 real functions
