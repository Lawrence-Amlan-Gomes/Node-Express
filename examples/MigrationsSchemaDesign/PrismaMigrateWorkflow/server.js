...
// logic lives in a controller behind them, same as every other Express
// topic in this project (see "Project Structure & Config").
...
// Needed so createPost's POST route can read req.body.
app.use(express.json());

// Every request under "/posts" is handed off to the real posts router.
