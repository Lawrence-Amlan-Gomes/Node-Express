// This is the server.js file for the "PostgresConnectionAndTypes" mini-project.
...
// port ONLY when this file is run directly (not when demo.js imports it).
...
if (require.main === module) { // Only run the code below if this exact file was started directly (not imported)
  const PORT = process.env.PORT ?? 4126; // Use the PORT from .env, or 4126 if none is set
