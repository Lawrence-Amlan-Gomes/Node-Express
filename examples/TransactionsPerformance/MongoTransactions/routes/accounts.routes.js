...
// POST /accounts/transfer — runs a real, all-or-nothing session.withTransaction.
router.post("/transfer", transfer);
// DELETE /accounts — clears every real account (used by demo.js to leave the collection empty when done).
